...
const RAIL_SRC = read('Sources/ConditionManager/Dashboard/SessionRail.swift');
const PAD_SRC = read('Sources/ConditionManager/Dashboard/MemoPad.swift');
const GOALADD_SRC = read('Sources/ConditionManager/Dashboard/GoalAddContent.swift');
...
module.exports = {
  ...
  DASH_CHAT_CSS: slice(read('Sources/ConditionManager/Dashboard/DashboardContent.swift'),
  ...
  TZ_JS: slice(read('Sources/ConditionManager/Dashboard/CMTimeFilter.swift'),
