...
```
claude mcp add --scope user suno -- node /Users/lioncho/Work/departtment_service/projects/condition-manager/Sources/ConditionManager/Plugins/suno-mcp/dist/index.js
```
