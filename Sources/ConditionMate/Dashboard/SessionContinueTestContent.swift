...
function caseFile(){
  ...
  setTimeout(function(){
    addTools(2, [
      {label:'Read Sources/ConditionMate/BGM/BGMLibrary.swift', detail:'214 lines — 트랙 메타(BPM/톤 태그) 구조 확인'},
      {label:'Read Sources/ConditionMate/Core/ConditionDirector.swift', detail:'현재 선곡: 활동량 → 목표 BPM → 최근접 트랙'},
...
function caseDebug(){
  ...
  setTimeout(function(){
    addTools(3, [
      ...
      {label:'Read ~/.condition-mate/activity/activity-2026-07-07.jsonl (tail)', detail:'{"t":…,"rate":41,"active":60,"phase":"PEAK","bpm":150,…}\n새벽인데 active 60초 연속 → 야간 작업으로 판정됨'},
      {label:'Read Sources/ConditionMate/Core/ConditionDirector.swift:88', detail:'phase 판정에 시간대 가중치 없음 — 활동량만 반영'},
