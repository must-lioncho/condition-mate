        ...
        <style>
          ...
          *{ box-sizing:border-box }
          ...
          /* 연동 관리 모달 — 이 페이지가 기대는 외부 연동(키 4개 + 보조 2개)의
             존재·실연결 상태를 한 화면에서 검증한다. 상태색 컨벤션: 신호등 금지 —
             정상=파랑, 확인 중(대기)=보라, 조치 필요=주황. */
          ...
          .irow .ist.ok{ color:#8fa3c0 } .irow .ist.ok .dot{ background:#4f7fd6 }
        ...
        function renderIntModal(){
          ...
          m.innerHTML = `<div class="ipanel" onmousedown="event.stopPropagation()">
            ...
            <div class="isub">이 페이지가 기대는 외부 연동의 키 등록(키체인)과 실제 연결을 한 번에 검증합니다 — 키 값은 표시하지 않습니다.
              키 등록·교체와 LLM 연동 관리는 <a href="/?plugins=1">플러그인 화면</a> 한곳에서 합니다.</div>
            ...
            <div class="ifoot">
              ...
              <button class="ghost" onclick="location.href='/?plugins=1'"
                title="키 등록·교체와 LLM 연동은 플러그인 화면 한곳에서 관리합니다">플러그인 연동 열기</button>
