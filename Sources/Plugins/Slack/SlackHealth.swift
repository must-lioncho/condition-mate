...
public enum SlackHealth {
    ...
    public struct Status {
        public var state: String     // ok | connecting | restarting | blocked | auth | stuck | notInstalled | off
    ...
    public static func statusJSON() -> String {
        ...
        out += ",\"realtimeAt\":\(realtimeAt),\"pollAt\":\(pollAt)"
    ...
    public static func restartNow() -> String {
        lock.lock(); kicks = 0; lastKickAt = nil; lastKickError = ""; lock.unlock()
