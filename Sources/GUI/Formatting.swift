...
public enum Formatting {
    ...
    public static let milestones: [Double] = [10, 50, 100, 200, 500, 1000, 2000, 5000, 10000]

    public static func hours(fromSeconds seconds: Double) -> Double {
        seconds / 3600.0
    }

    // "1,024.5h"
    public static func hoursLabel(_ seconds: Double) -> String {
    ...
    public static func nextMilestone(forSeconds seconds: Double) -> Double? {
        let h = hours(fromSeconds: seconds)
        return milestones.first { $0 > h }
    }

    // Progress text toward the next milestone, e.g. "다음 1,000h까지 75.5h 남음".
    public static func milestoneProgress(forSeconds seconds: Double) -> String {
        let h = hours(fromSeconds: seconds)
    ...
    public static func agoLabel(_ seconds: Int) -> String {
    ...
    public static func compactHours(_ seconds: Double) -> String {
        let h = hours(fromSeconds: seconds)
